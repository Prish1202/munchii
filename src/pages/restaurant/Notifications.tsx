      ...
      <div className="max-w-lg mx-auto pb-28 md:pb-6 space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <Link to="/restaurant/notification-settings" className="p-1.5 rounded-lg hover:bg-muted transition-colors">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-16 space-y-3">
            ...
            <p className="text-muted-foreground text-xs">You'll be notified about new orders, earnings, and more</p>
          </div>
        ) : (
