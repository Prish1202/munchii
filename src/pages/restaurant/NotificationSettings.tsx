...
import { Bell, ShoppingBag, TrendingUp, AlertCircle, Volume2, Vibrate, Smartphone, ArrowLeft, Loader2 } from 'lucide-react';
    ...
    <DashboardLayout>
      <div className="max-w-lg mx-auto pb-28 md:pb-6 space-y-6">
        <div className="flex items-center gap-3">
          <Link to="/restaurant/notifications" className="p-2 rounded-xl hover:bg-muted transition-colors">
        ...
        <div className="space-y-2">
          ...
          <SettingRow
            ...
            title="Cancellations"
            description="Cancelled order alerts"
            checked={preferences.order_notifications}
            onToggle={toggle('order_notifications')}
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <SettingRow
            ...
            title="Sound"
            description="Play a sound for new orders and alerts"
