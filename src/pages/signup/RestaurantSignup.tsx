...
export default function RestaurantSignup() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden restaurant-theme">
      ...
      >
        <div className="text-center space-y-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-1">Register your restaurant on our platform</p>
          </div>
        ...
        <Card className="shadow-xl border-0 glass-strong rounded-2xl">
          <CardHeader className="pb-4">
            <CardTitle className="text-xl font-display">Restaurant Registration</CardTitle>
            <CardDescription>Create your partner account to start receiving orders</CardDescription>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="signup-email" type="email" placeholder="you@restaurant.com" value={email} onChange={(e) => setEmail(e.target.value)} required className="bg-background rounded-xl" />
              </div>
              <div className="space-y-2">
