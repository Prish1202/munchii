...
import { UtensilsCrossed, Eye, EyeOff, ShoppingBag } from 'lucide-react';
        ...
        <Card className="shadow-xl border-0 glass-strong rounded-2xl">
          ...
          <CardContent>
            ...
            <div className="text-center text-sm text-muted-foreground pt-2">
              ...
              <Link to="/signup/restaurant" className="text-primary hover:underline font-medium">Register here</Link>
            </div>
          </CardContent>
        </Card>
